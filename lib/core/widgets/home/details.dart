...
class _DetailsState extends State<Details> {
  ...
  final String DynamicLink = 'https://www.google.com?screen=/profile';
  final String Link = 'https://waveyy.page.link/signal';
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://waveyy.page.link',
      link: Uri.parse('https://www.google.com?screen=${widget.image}'),
      androidParameters: const AndroidParameters(
        packageName: 'com.example.wave',
        minimumVersion: 0,
      ),
    ...
    if (short) {
      ...
      Share.share('check out my post $url');
      print(url);
    } else {
